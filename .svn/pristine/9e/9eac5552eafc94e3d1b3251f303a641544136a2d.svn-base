  ...
  <div class="reportRegistration">
    ...
    <div class="work_table">
      ...
      >
        ...
        <el-table-column prop="accdentdate" label="出险日期" align="center"></el-table-column>
        <el-table-column prop="reportchnl" label="案件渠道" align="center"></el-table-column>
        <el-table-column prop="assistant" label="理赔辅助咨询" align="center"></el-table-column>
      </el-table>
