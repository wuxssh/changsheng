    ...
    <div class="left">
              ...
              <!-- <el-col :span="8">
                <div class="grid-content">
                  <el-form-item label="疾病分类">
                    <el-radio-group v-model="dangerInfor.dieasetype">
                      <el-radio
              ...
              <!-- <el-col :span="8">
                <div class="grid-content">
                  <el-form-item label="诊断依据">
                    <el-select v-model="dangerInfor.dianobasis" disabled multiple>
                      <el-option
              ...
              <el-col :span="8">
                <div class="grid-content">
                  <el-form-item label="申请豁免原因">
                    <!-- <el-select v-if ="dangerInfor.accidenttype==='01'" v-model="dangerInfor.exempt" clearable placeholder="请选择">
                                                        <el-option v-for="item in resource" :key="item.value" :label="item.text" :value="item.value">
                                                        </el-option>
                                                      </el-select>
                                  
                                                      <el-select v-else-if ="dangerInfor.accidenttype==='02'" v-model="dangerInfor.exempt" clearable placeholder="请选择">
                                                        <el-option v-for="item in resource1" :key="item.value" :label="item.text" :value="item.value">
                                                        </el-option>
                                                      </el-select>
                                  
                                                      <el-select v-else v-model="dangerInfor.exempt" exempt placeholder="请选择">
                                                        <el-option v-for="item in resource2" :key="item.value" :label="item.text" :value="item.value">
                                                        </el-option>
                    </el-select>-->
      ...
      <!-- <div style="overflow:hidden">
        <div style="float:right;margin:10px 10px 30px 0">
          ...
          <el-button type="primary" round @click="toQueryExempt()">豁免查询</el-button>
