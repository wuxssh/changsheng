...
import MapFar from "@/components/charts/MapFar";
...
export default {
  ...
  created() {
    ...
    this.getcasenumdate("", "all");
    this.getcasepaydate("", "all1");
    ...
    post(service.toppay, {
      ...
      if (res.data.headers.code === "200" && res.data.headers.success) {
        ...
        console.log("top结构---------", this.lineobj);
    ...
    post(service.numbychannel, {
      ...
      if (res.data.headers.code === "200" && res.data.headers.success) {
        console.log("各渠道赔付件数及占比", res.data.bodys);
        this.$nextTick(() => {
    ...
    post(service.paybychannel, {
      ...
      if (res.data.headers.code === "200" && res.data.headers.success) {
        console.log("各渠道赔付金额及占比", res.data.bodys);
        this.$nextTick(() => {
    ...
    post(service.paynum, { bodys: {} }).then(res => {
      console.log("4444444444--------------", res.data.bodys);
    ...
    post(service.areanum).then(res => {
      ...
      getmapdata(res.data.bodys);
    });
    //区域图

    // this.$nextTick(() => {
    //   this.drawChart("amountPay1", {
    //     xAxis: ["2015", "2016", "2017", "2018", "2019"],
    //     Approved1: ["1000", "800", "900", "400", "500"],
    //     Approved2: ["200", "100", "300", "400", "500"],
    //     Approved3: ["300", "200", "100", "700", "500"],
    //     Approved4: ["200", "100", "300", "500", "200"],
    //     Approved5: ["600", "200", "100", "600", "500"]
    //   });
    // }),
    // this.$nextTick(() => {
    //   this.drawChart("amountPay2", {
    //     xAxis: ["2015", "2016", "2017", "2018", "2019"],
    //     Approved1: ["1000", "800", "900", "400", "500"],
    //     Approved2: ["200", "100", "300", "400", "500"],
    //     Approved3: ["300", "200", "100", "700", "500"],
  ...
  mounted() {
    let isWidth = document.defaultView.getComputedStyle(document.getElementById("isTitle")).width
  ...
  methods: {
    ...
    top5changedate() {
      console.log(this.top5.startdate, this.top5.enddate);
      let ysatrttime;
      let yendtime;
      let ystartyear;
      let yendyear;
      ...
      if (type === "medical") {
        if (this.startdate && this.enddate) {
          if (
            ...
            this.getcasenumdate("01", "medical");
            this.getcasepaydate("01", "medical1");
          }
        }
      } else if (type === "life") {
        if (this.lifedate.startdate && this.lifedate.enddate) {
          if (
            ...
            this.getcasenumdate("02", "life");
            this.getcasepaydate("02", "life1");
          }
        }
        ...
        if (this.illnessdate.startdate && this.illnessdate.enddate) {
          if (
            ...
            this.getcasenumdate("03", "illness");
            this.getcasepaydate("03", "illness1");
          }
        }
        ...
        if (this.accidentdate.startdate && this.accidentdate.enddate) {
          if (
            ...
            this.getcasenumdate("04", "accident");
            this.getcasepaydate("04", "accident1");
          }
        }
      } else if (type === "all") {
        if (this.alldate.startdate && this.alldate.enddate) {
          if (
            ...
            this.getcasenumdate("05", "all");
            this.getcasepaydate("05", "all1");
          }
        }
      }
