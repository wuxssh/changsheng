    ...
    <el-container style="overflow:auto;">
      <el-container style="overflow:auto;">
              ...
              <el-collapse-item name="3" id="5">
                  ...
                  <el-col :span="8">
                    <div class="grid-content">
                      <el-form-item label="意外事故受伤程度">
                        <el-select v-model="objForm.accdegree" clearable disabled>
                          <el-option
                ...
                <div class="grid-content">
                  <el-form-item label="疾病分类">
                    <el-radio-group v-model="objForm.dieasetype" disabled>
                ...
                <div class="grid-content">
                  <el-form-item label="诊断依据">
                    <el-select v-model="objForm.dianobasis" clearable multiple disabled>
                      <el-option
                  ...
                  <el-col :span="16">
                    <div class="grid-content apply_address">
                      <el-form-item label="联系地址">
                        ...
                        <span class="full">
                          <el-input v-model="objForm.rgtantaddress" maxlength="100" disabled></el-input>
                        </span>
                      </el-form-item>
                    </div>
                  </el-col>
                  ...
                  <el-col :span="8">
                    <div class="grid-content">
                      <el-form-item label="账户所有人姓名">
                        <el-input v-model="objForm.recename" maxlength="20" disabled></el-input>
                      </el-form-item>
                    </div>
                  </el-col>
                  <el-col :span="8">
                    <div class="grid-content">
                      <el-form-item label="账户所有人身份证件号码">
                        <el-input
                  ...
                  <el-col :span="8">
                    <div class="grid-content">
                      <el-form-item label="联系方式">
                        <el-input v-model="objForm.contactway" maxlength="100" disabled></el-input>
                      </el-form-item>
                    </div>
                  </el-col>
                </el-row>
                  ...
                  <el-col :span="8">
                    <div class="grid-content">
                      <el-form-item label="授权账户号码">
                        <el-input v-model="objForm.bankaccno" maxlength="100" disabled></el-input>
                      </el-form-item>
                    </div>
                  </el-col>
                  <el-col :span="16">
                    <div class="grid-content bank">
                      ...
                      <el-form-item label class="bank_style">
                        <el-select v-model="objForm.bankname" filterable disabled>
                          <el-option
                  ...
                  <el-col :span="8">
                    <div class="grid-content">
                      <el-form-item label="职业">
                        <el-select v-model="objForm.profession" disabled>
                          <el-option
                  ...
                  <el-col :span="8">
                    <div class="grid-content">
                      <el-form-item label="年收入">
                        <el-input v-model="objForm.annualincome" maxlength="100" disabled></el-input>
                      </el-form-item>
                    </div>
                  </el-col>
                </el-row>
                  ...
                  <el-col :span="8">
                    <div class="grid-content">
                      <el-form-item label="单位名称">
                        <el-input v-model="objForm.workunit" maxlength="100" disabled></el-input>
                      </el-form-item>
                    </div>
                  </el-col>
                  <el-col :span="8">
                    <div class="grid-content">
                      <el-form-item label="单位地址">
                        <el-input v-model="objForm.workaddress" maxlength="100" disabled></el-input>
                      </el-form-item>
                    </div>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="24">
                    <div class="grid-content address">
                      ...
                      <el-form-item label class="address_style">
                        <span class="full">
                          <el-input v-model="objForm.receiveaddress" maxlength="100" disabled></el-input>
                        </span>
                      </el-form-item>
                    </div>
                  </el-col>
        ...
        :tableMes="tableMessage5,tableMessage1,tableMessage2,tableMessage3,tableMessage4"
            ...
            <div class="work_queue" style="margin-top: 15px;" id="18">
              <!-- <img src="../../assets/images/report/tab_btn@1x.png" alt=""> -->
              <span name="14" id="13">审批管理</span>
              <div class="box"></div>
            </div>
            <el-table
  ...
  methods: {
    ...
    initInfor() {
      ...
      axios.all(_this.axiosList).then(function(res) {
        ...
        console.log(_this.tableMessage1);
        ...
        console.log(_this.auditMangeArray);
        ...
        // //获取理赔类型
        console.log(_this.objForm);
        _this.bigObj = JSON.stringify(_this.objForm);
        console.log(_this.objForm);
        console.log(JSON.stringify(_this.objForm));
        console.log(JSON.parse(_this.bigObj));
      });
    },
    initData() {
      // 赔案计算信息
    ...
    //   }).then(res => {
    //     if (res.data.header.code === "200") {
    //          this.hospitalList = res.data.bodys
    //          sessionStorage.setItem('hospitalList', JSON.stringify(this.hospitalList))
    //         // console.log(this.sexList + this.cardTypeList)
