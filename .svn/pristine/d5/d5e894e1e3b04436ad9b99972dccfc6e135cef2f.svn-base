  ...
  <div class="taskList">
    ...
    <div class="work_table">
      ...
      >
        ...
        <el-table-column prop="customerno" label="客户号" align="center" min-width="150" sortable></el-table-column>
        <el-table-column prop="customername" label="客户姓名" align="center" min-width="150"></el-table-column>
        <el-table-column prop="idtype" label="证件类型" align="center" min-width="150">
        ...
        <el-table-column prop="vipflag" label="客户标识" align="center" min-width="200">
          <template slot-scope="scope">      
            <img
        ...
        <el-table-column prop="accidenttype" label="出险类型" align="center" min-width="150">
          <template slot-scope="scope">
            <span>{{scope.row.accidenttype}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="accidentdate" label="出险日期" sortable min-width="150"></el-table-column>
      </el-table>
