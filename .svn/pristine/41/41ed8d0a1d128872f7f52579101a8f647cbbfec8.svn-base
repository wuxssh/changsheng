      ...
      <el-collapse-item name="1">
        ...
        >
          ...
          <el-row style="text-align:right;padding-right:30px;">
            <el-button type="primary" round @click="generateComprehensiveReportForm('listForm')">打印理赔综合服务报表</el-button>
          </el-row>
        </el-form>
      </el-collapse-item>
    </el-collapse>
...
export default {
  ...
  mounted() {},
  methods: {
    generateComprehensiveReportForm(formName) {
      this.$refs[formName].validate(valid => {
        if (!valid) {
          ...
          post(service.generateComprehensiveReportForm, {
            bodys: {
