      ...
      <el-collapse-item name="1">
        ...
        >
          ...
          <el-row style="text-align:right;padding-right:30px;">
            <el-button type="primary" round @click="generateClaimKpiReportForm('listForm')">打印公司KPI考核(营销)</el-button>
          </el-row>
        </el-form>
      </el-collapse-item>
    </el-collapse>
...
export default {
  ...
  mounted() {},
  methods: {
    generateClaimKpiReportForm(formName) {
      this.$refs[formName].validate(valid => {
        if (!valid) {
          ...
          post(service.generateClaimKpiReportForm, {
            bodys: {
