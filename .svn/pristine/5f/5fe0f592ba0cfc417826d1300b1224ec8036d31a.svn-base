...
export default {
  ...
  created() {
    if (
      this.$route.params.rgtno &&
      this.$route.params.customerno
  ...
  methods: {
    ...
    getDetail1(data) {
      if (!data.mainfeeno) {
        ...
        localStorage.setItem("dialogVisible", this.dialogVisible);
        this.mainData1 = data;
        post(service.getcfeeDetail, {
          bodys: {
            // rgtno:JSON.parse(this.$route.params.dataOfTable).rgtno,
            // rgtno: JSON.parse(this.$route.params.dataOfTable).rgtno,
            rgtno: this.$route.params.rgtno,
