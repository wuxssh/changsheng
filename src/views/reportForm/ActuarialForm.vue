      ...
      <el-collapse-item name="1">
        ...
        >
          ...
          <el-row style="text-align:right;padding-right:30px;">
            <el-button type="primary" round @click="generateActuarialReportForm('listForm')">打印个险理赔精算报表</el-button>
          </el-row>
        </el-form>
      </el-collapse-item>
    </el-collapse>
...
export default {
  ...
  methods: {
    ...
    generateActuarialReportForm(formName) {
      this.$refs[formName].validate(valid => {
        if (!valid) {
          ...
          post(service.generateActuarialReportForm, {
            bodys: {
