        ...
        <el-collapse-item name="5" id="7">
          ...
          <el-form ref="form" :model="form" v-model="labelPosition" label-width="135px">
            <!-- <el-row>
               <el-col :span="8">
                <div class="grid-content">
                  <el-form-item label="与被保险人关系" prop="recename">
                    <el-select
                      v-model="objForm.aa"
                      clearable
                    >
              ...
              <el-col :span="8">
                <div class="grid-content">
                  <el-form-item label="账户所有人姓名">
                    <el-input v-model="drawMoneyInfor.name" disabled class="disabledinput"></el-input>
                  </el-form-item>
                </div>
              </el-col>
              <el-col :span="8">
                <div class="grid-content">
                  <el-form-item label="账户所有人身份证件号码" class="midSty">
                    <el-input v-model="drawMoneyInfor.idno" disabled class="disabledinput"></el-input>
                  </el-form-item>
                </div>
              </el-col>
              <el-col :span="8">
                <div class="grid-content">
                  <el-form-item label="联系方式">
                    <el-input v-model="drawMoneyInfor.contactway" disabled class="disabledinput"></el-input>
                  </el-form-item>
                </div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <div class="grid-content">
                  <el-form-item label="授权账户号码">
                    <el-input v-model="drawMoneyInfor.bankaccno" disabled class="disabledinput"></el-input>
                  </el-form-item>
                </div>
              </el-col>

              <el-col :span="16">
                <div class="grid-content place bank">
                  <el-form-item label="授权银行">
                    <el-input v-model="drawMoneyInfor.bankname" disabled class="disabledinput"></el-input>
                    <el-input v-model="drawMoneyInfor.provincename" disabled class="disabledinput"></el-input>
                    <el-input v-model="drawMoneyInfor.branchname" disabled class="disabledinput"></el-input>
                  </el-form-item>
                </div>
              </el-col>
              ...
              <el-col :span="6">
                <div class="grid-content">
                  <el-form-item>
                    <el-input v-model="drawMoneyInfor.provincename" disabled></el-input>
                  </el-form-item>
                </div>
              </el-col>
              <el-col :span="6">
                <div class="grid-content">
                  <el-form-item>
                    <el-input v-model="drawMoneyInfor.cityname" disabled></el-input>
                  </el-form-item>
                </div>
              </el-col>
              <el-col :span="6">
                <div class="grid-content">
                  <el-form-item>
                    <el-input v-model="drawMoneyInfor.branch" disabled></el-input>
                  </el-form-item>
                </div>
              </el-col>-->
            </el-row>
              ...
              <el-col :span="8">
                <div class="grid-content">
                  <el-form-item label="职业">
                    ...
                    <el-select
                      v-model="drawMoneyInfor.profession"
                      placeholder="请选择"
                      disabled
                      :class="drawMoneyInfor.profession?'disabledinput':''"
                    >
                      <el-option
              ...
              <el-col :span="8">
                <div class="grid-content">
                  <el-form-item label="年收入">
                    <el-input v-model="drawMoneyInfor.annualincom" disabled class="disabledinput"></el-input>
                  </el-form-item>
                </div>
              </el-col>
            </el-row>
              ...
              <el-col :span="8">
                <div class="grid-content">
                  <el-form-item label="单位名称">
                    <el-input v-model="drawMoneyInfor.workunit" disabled class="disabledinput"></el-input>
                  </el-form-item>
                </div>
              </el-col>
              <el-col :span="8">
                <div class="grid-content">
                  <el-form-item label="单位地址">
                    <el-input v-model="drawMoneyInfor.workaddress" disabled class="disabledinput"></el-input>
                  </el-form-item>
                </div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="24">
                <div class="grid-content lingAdress">
                  <el-form-item label="联系地址">
                    <el-input
                    ...
                    ></el-input>
                    <el-input
                      v-model="drawMoneyInfor.receiveacccityname"
                      disabled
                      class="disabledinput"
                    ></el-input>
                    <el-input
                      v-model="drawMoneyInfor.receivedistrictname"
                      disabled
                      class="disabledinput"
                    ></el-input>
                    <span style="width:255px;display:inline-block;">
      ...
      <div style="overflow:hidden;margin-bottom: 40px;">
        <div style="float:right;margin:10px 10px 30px 0">
          <!-- <el-button type="primary" round>
                    <router-link tag="span" to="/eAListDetails">医疗单证</router-link>
          </el-button>-->
          <!-- <el-button type="primary" @click="saveAudit()" round>保 存</el-button> -->
      ...
      bottom: -6.5px">
        ...
        <div style="text-align:center;" class="button_style">
          ...
          <el-button
            ...
            size="mini"
          >合同处理</el-button>
          <el-button type="primary" round @click="remarks()" size="mini">备注信息</el-button>
          <el-button
            type="primary"
            round
            size="mini"
                ...
                <div class="innerLable1">
                  <div class="contentss">
                    <div class="note" style="text-align:left">
                      <span
                        style="font-size:18px;margin-left:10px;margin-top:15px;color:#409eff"
                      >备注内容</span>
                      <img
