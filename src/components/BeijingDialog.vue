        ...
        >
          ...
          <el-table-column prop="billno" width="200">
            ...
            <template slot-scope="scope">
              <el-input v-model="scope.row.billno" maxlength="100"></el-input>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="selfcashpaymoney" label="个人现金支付金额" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.selfcashpaymoney"
          ...
          <el-table-column prop="selfaccountpaymoney" label="个人账户支付金额" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.selfaccountpaymoney"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="medicallypayment" label="医疗保险范围内金额" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.medicallypayment"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="totalmedicallypayment" label="累计医保范围内金额" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.totalmedicallypayment"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="yearmutualitybigpay" label="年度门诊大额累计支付" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.yearmutualitybigpay"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="insurancepayment" label="医疗保险基本支付金额" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.insurancepayment"
                @blur="getAll(scope.row,'C')"
                maxlength="13"
                min="0"
              ></el-input>
            </template>
          </el-table-column>
          <el-table-column prop="sociflag" label="社保标志" width="250">
            <template slot="header" slot-scope="scope">
              <span class="redStars">&nbsp;*&nbsp;</span>
              <span>社保标志</span>
            </template>
          ...
          <el-table-column prop="mutualitybigpay" label="门诊大额支付" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.mutualitybigpay"
                @blur="getAll(scope.row,'C')"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="retirementpayment" label="退休保险支付" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.retirementpayment"
                @blur="getAll(scope.row,'C')"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="disabilitysoldier" label="残疾军人支付" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.disabilitysoldier"
                @blur="getAll(scope.row,'C')"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="civilservants" label="公务员医疗支付" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.civilservants"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="balancemutualitymoney" label="年度门诊大额余额" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.balancemutualitymoney"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="individualpayment" label="个人自付" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.individualpayment"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="individualpaya" label="自付一" width="200">
            ...
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.individualpaya"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="individualpayb" width="200">
            ...
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.individualpayb"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column label="操作" width="200">
            <template slot-scope="scope">
              <el-button
                size="mini"
                @click="deleteOne(scope.$index,scope.row,medicalClinic,'C')"
              >删 除</el-button>
      ...
      <div class="work_table">
        ...
        >
          ...
          <el-table-column prop="totalmutualitypayment" label="大额互助资金累计支付" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.totalmutualitypayment"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="selfliabilitiesa" label="自负一小计" width="200">
            ...
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.selfliabilitiesa"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="ordinaltionfund" label="统筹基金本次支付" width="200">
            ...
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.ordinaltionfund"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="totalordinaltionfund" label="统筹基金累计支付" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.totalordinaltionfund"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="selfliabilitiesb" label="自负二小计" width="200">
            ...
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.selfliabilitiesb"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
      ...
      <div class="work_table">
        ...
        >
          ...
          <el-table-column prop="imhospdate" label="重症病房天数" width="200">
            <template slot-scope="scope">
              <el-input v-model="scope.row.imhospdate" @blur="checkUnumber2(scope.row)"></el-input>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="ordinaltionfundpay" label="统筹基金支付金额" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.ordinaltionfundpay"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="outmedicallypayment" label="医疗保险范围外金额" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.outmedicallypayment"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
          ...
          <el-table-column prop="selfpaytatol" label="个人负担合计" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.selfpaytatol"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
      ...
      <div class="work_table">
        ...
        >
          ...
          <el-table-column prop="deductionfeemount" label="费用扣减金额" width="200">
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.deductionfeemount"
                @blur="getAll(scope.row)"
                maxlength="13"
                min="0"
              ></el-input>
      ...
      <div class="work_table">
        ...
        >
          ...
          <el-table-column prop="ruralmedicalinsurance" label="新农合报销金额" width="200">
            ...
            <template slot-scope="scope">
              <el-input
                v-model="scope.row.ruralmedicalinsurance"
                @blur="getAll(scope.row,'H')"
                maxlength="13"
                min="0"
              ></el-input>
        ...
        >
          ...
          <el-table-column label="操作" width="200">
            <template slot-scope="scope">
              <el-button
                size="mini"
                @click="deleteOne(scope.$index,scope.row,medicalSpecial,'I')"
              >删 除</el-button>
        ...
        >
          ...
          <el-table-column label="操作" width="200">
            <template slot-scope="scope">
              <el-button
                size="mini"
                @click="deleteOne(scope.$index,scope.row,commonHospital,'K')"
              >删 除</el-button>
      ...
      <el-dialog title :visible.sync="dialogVisible" width="70%" append-to-body>
        ...
        <el-table :data="zdDetail.slice((currentPageC-1)*10,currentPageC*10)" center="true">
          ...
          <el-table-column prop="dinictype" label="诊断类型" align="center" clearable>
            ...
            <template slot-scope="scope">
              <el-select placeholder="请选择" v-model="scope.row.dinictype" clearable>
                <el-option
...
export default {
  ...
  methods: {
    ...
    checkUnumber1(row, index) {
      let aa = /^[0-9]+([.]{1}[5]){0,1}$/;
      console.log(row.realhospdate);

      // this.realDate[index] = row.realhospdate;
      if (!aa.test(row.realhospdate)) {
        this.$message({
          message: "修改天数只能0.5的倍数调整",
          type: "error"
        });
        if (row.hospenddate && row.hospstartdate) {
          if (row.hospenddate == row.hospstartdate) {
            row.realhospdate = sumDays(row.hospstartdate, row.hospenddate) + 1;
          } else {
            row.realhospdate = sumDays(row.hospstartdate, row.hospenddate);
          }
          this.realDate[index] = row.realhospdate;
        }
        ...
        if (
          ...
          if (row.hospenddate && row.hospstartdate) {
            if (row.hospenddate == row.hospstartdate) {
              row.realhospdate =
                sumDays(row.hospstartdate, row.hospenddate) + 1;
            } else {
              row.realhospdate = sumDays(row.hospstartdate, row.hospenddate);
            }
            this.realDate[index] = row.realhospdate;
    ...
    checkUnumber2(data) {
      // let aa = /^[0-9]+([.]{1}[5]){0,1}$/;
      let aa = /^[0-9]+([.]{1}[0-9]+){0,1}$/;
      if (!aa.test(data.imhospdate)) {
        // this.$message({
        //   message: "可填写一位小数，且必须是0.5",
        //   type: "error"
        // });
        data.imhospdate = null;
      } else {
        function getPointNum(num) {
          if (num.indexOf(".")) {
            ...
            let a = str.slice(index + 1, index + 2);
            console.log(a);
            if (a > 5) {
            ...
            if (a == 5) {
              num = str.substring(0, index + 2);
            }

            return num;
          }
        }
        data.imhospdate = getPointNum(data.imhospdate);
      }
    },
    // 医疗保险基金支付金额
    totalHos(res) {},
    ...
    changeFeeitemdetil(type, obj) {
      ...
      for (var key in this.fyDetailList1) {
        if (type == this.fyDetailList1[key].itemname) {
          obj.fee = this.fyDetailList1[key].itemprice;
          if (obj.fee) {
          ...
          obj.specifications = this.fyDetailList1[key].itemspec;
          obj.healthcaretype = this.fyDetailList1[key].medicaltype;
        }
      }
    },
    ...
    loadmoreDiag() {
      ...
      if (this.filterdiagVal) {
        this.formData1.likename = this.filterdiagVal;
      }
      this.getDiagnosis(this.formData1);
    },
    ...
    entryDetails(data1, data2, data3) {
      ...
      console.log("nnb1", data2);
      if (data2.medicinerequestreceiptlist.length != 0) {
    ...
    postDetail() {
      ...
      _this.medicalClinic[_this.listIndex].feemount = 0;
    ...
    beSure() {
      ...
      if (_this.kfDetail.length == 0 && _this.fyDetail == 0) {
        ...
        if (_this.mainData1.feetype == "C") {
          ...
          _this.medicalApproval[_this.listIndex].medicinerequestreceiptlist =
            _this.fyDetail;
          _this.medicalApproval[_this.listIndex].medicinerequestdeductlist =
            _this.kfDetail;
          _this.medicalApproval[_this.listIndex].diaglist = _this.zdDetail;
          _this.medicalApproval[_this.listIndex].operationlist = _this.ssDetail;
          _this.medicalApproval[_this.listIndex].feemount = 0;
          _this.medicalApproval[
            _this.listIndex
          ].medicinerequestreceiptlist.forEach(item => {
            _this.medicalApproval[_this.listIndex].feemount += new Number(
              item.price
            );
          });
          _this.medicalApproval[_this.listIndex].deductfee = 0;
          _this.medicalApproval[
            _this.listIndex
          ].medicinerequestdeductlist.forEach(item => {
            _this.medicalApproval[_this.listIndex].deductfee += new Number(
              item.deductfee
            );
          });
        } else if (_this.mainData1.feetype == "E") {
          _this.medicareHospital[_this.listIndex].medicinerequestreceiptlist =
            _this.fyDetail;
          _this.medicareHospital[_this.listIndex].medicinerequestdeductlist =
            _this.kfDetail;
          _this.medicareHospital[_this.listIndex].diaglist = _this.zdDetail;
          _this.medicareHospital[_this.listIndex].operationlist =
            _this.ssDetail;
          _this.medicareHospital[_this.listIndex].billmoney = 0;
          _this.medicareHospital[
            _this.listIndex
          ].medicinerequestreceiptlist.forEach(item => {
            _this.medicareHospital[_this.listIndex].billmoney += new Number(
              item.price
            );
          });
          _this.medicareHospital[_this.listIndex].deductfee = 0;
          _this.medicareHospital[
            _this.listIndex
          ].medicinerequestdeductlist.forEach(item => {
            _this.medicareHospital[_this.listIndex].deductfee += new Number(
              item.deductfee
            );
          });
        } else if (_this.mainData1.feetype == "F") {
          _this.fertilityClinic[_this.listIndex].medicinerequestreceiptlist =
            _this.fyDetail;
          _this.fertilityClinic[_this.listIndex].medicinerequestdeductlist =
            _this.kfDetail;
          _this.fertilityClinic[_this.listIndex].diaglist = _this.zdDetail;
          _this.fertilityClinic[_this.listIndex].operationlist = _this.ssDetail;
          _this.fertilityClinic[_this.listIndex].receiptfee = 0;
          _this.fertilityClinic[
            _this.listIndex
          ].medicinerequestreceiptlist.forEach(item => {
            _this.fertilityClinic[_this.listIndex].receiptfee += new Number(
              item.price
            );
          });
          _this.fertilityClinic[_this.listIndex].deductfee = 0;
          _this.fertilityClinic[
            _this.listIndex
          ].medicinerequestdeductlist.forEach(item => {
            _this.fertilityClinic[_this.listIndex].deductfee += new Number(
              item.deductfee
            );
          });
        } else if (_this.mainData1.feetype == "G") {
          _this.fertilityHospital[_this.listIndex].medicinerequestreceiptlist =
            _this.fyDetail;
          _this.fertilityHospital[_this.listIndex].medicinerequestdeductlist =
            _this.kfDetail;
          _this.fertilityHospital[_this.listIndex].diaglist = _this.zdDetail;
          _this.fertilityHospital[_this.listIndex].operationlist =
            _this.ssDetail;
          _this.fertilityHospital[_this.listIndex].billmoney = 0;
          _this.fertilityHospital[
            _this.listIndex
          ].medicinerequestreceiptlist.forEach(item => {
            _this.fertilityHospital[_this.listIndex].billmoney += new Number(
              item.price
            );
          });
          _this.fertilityHospital[_this.listIndex].deductfee = 0;
          _this.fertilityHospital[
            _this.listIndex
          ].medicinerequestdeductlist.forEach(item => {
            _this.fertilityHospital[_this.listIndex].deductfee += new Number(
              item.deductfee
            );
          });
        } else if (_this.mainData1.feetype == "H") {
          _this.NCMSHospital[_this.listIndex].medicinerequestreceiptlist =
            _this.fyDetail;
          _this.NCMSHospital[_this.listIndex].medicinerequestdeductlist =
            _this.kfDetail;
          _this.NCMSHospital[_this.listIndex].diaglist = _this.zdDetail;
          _this.NCMSHospital[_this.listIndex].operationlist = _this.ssDetail;
          _this.NCMSHospital[_this.listIndex].billmoney = 0;
          _this.NCMSHospital[
            _this.listIndex
          ].medicinerequestreceiptlist.forEach(item => {
            _this.NCMSHospital[_this.listIndex].billmoney += new Number(
              item.price
            );
          });
          _this.NCMSHospital[_this.listIndex].deductfee = 0;
          _this.NCMSHospital[_this.listIndex].medicinerequestdeductlist.forEach(
            item => {
              _this.NCMSHospital[_this.listIndex].deductfee += new Number(
                item.deductfee
              );
            }
          );
        } else if (_this.mainData1.feetype == "I") {
          _this.medicalSpecial[_this.listIndex].medicinerequestreceiptlist =
            _this.fyDetail;
          _this.medicalSpecial[_this.listIndex].medicinerequestdeductlist =
            _this.kfDetail;
          _this.medicalSpecial[_this.listIndex].diaglist = _this.zdDetail;
          _this.medicalSpecial[_this.listIndex].operationlist = _this.ssDetail;
          _this.medicalSpecial[_this.listIndex].specialfeemount = 0;
          _this.medicalSpecial[
            _this.listIndex
          ].medicinerequestreceiptlist.forEach(item => {
            _this.medicalSpecial[_this.listIndex].specialfeemount += new Number(
              item.price
            );
          });
          _this.medicalSpecial[_this.listIndex].deductfee = 0;
          _this.medicalSpecial[
            _this.listIndex
          ].medicinerequestdeductlist.forEach(item => {
            _this.medicalSpecial[_this.listIndex].deductfee += new Number(
              item.deductfee
            );
          });
        } else if (_this.mainData1.feetype == "J") {
          _this.commonOutpatient[_this.listIndex].medicinerequestreceiptlist =
            _this.fyDetail;
          _this.commonOutpatient[_this.listIndex].medicinerequestdeductlist =
            _this.kfDetail;
          _this.commonOutpatient[_this.listIndex].diaglist = _this.zdDetail;
          _this.commonOutpatient[_this.listIndex].operationlist =
            _this.ssDetail;
          _this.commonOutpatient[_this.listIndex].receiptfee = 0;
          _this.commonOutpatient[
            _this.listIndex
          ].medicinerequestreceiptlist.forEach(item => {
            _this.commonOutpatient[_this.listIndex].receiptfee += new Number(
              item.price
            );
          });
          _this.commonOutpatient[_this.listIndex].deductfee = 0;
          _this.commonOutpatient[
            _this.listIndex
          ].medicinerequestdeductlist.forEach(item => {
            _this.commonOutpatient[_this.listIndex].deductfee += new Number(
              item.deductfee
            );
          });
        } else if (_this.mainData1.feetype == "K") {
          _this.commonHospital[_this.listIndex].medicinerequestreceiptlist =
            _this.fyDetail;
          _this.commonHospital[_this.listIndex].medicinerequestdeductlist =
            _this.kfDetail;
          _this.commonHospital[_this.listIndex].diaglist = _this.zdDetail;
          _this.commonHospital[_this.listIndex].operationlist = _this.ssDetail;
          _this.commonHospital[_this.listIndex].billmoney = 0;
          _this.commonHospital[
            _this.listIndex
          ].medicinerequestreceiptlist.forEach(item => {
            _this.commonHospital[_this.listIndex].billmoney += new Number(
              item.price
            );
          });
          _this.commonHospital[_this.listIndex].deductfee = 0;
          _this.commonHospital[
            _this.listIndex
          ].medicinerequestdeductlist.forEach(item => {
            _this.commonHospital[_this.listIndex].deductfee += new Number(
              item.deductfee
            );
          });
        }
    ...
    applyTask() {
      if (
        ...
        post(service.beijngmedicine, {
          bodys: {
            customerno: this.bjObjForm.customerno,
            rgtno: this.bjObjForm.rgtno,
    ...
    addRow(tableData, event) {
      if (event == "C") {
        tableData.push({
          ...
          hospitalname:
            tableData.length == 0
              ? this.bjObjForm.hospitalname
              : tableData[tableData.length - 1].hospitalname,
          clinicdate: null,
          feemount: 0,
